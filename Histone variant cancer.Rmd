...
# !!README!!
frist download data from the onedrive with the following link:
https://livejohnshopkins-my.sharepoint.com/:f:/g/personal/yhuan279_jh_edu/Egg3oIt1YdNEnxVyetSnKXQBkvdcYdGixwxKkPMXpUFPBA?e=5yaMEl
...
run the code for preprocessing your data
```{r}
...
# analyze the expression level of the gene across all cancer type
...
# draw the box plot of expression level of H2AFY
```{r}
...
# Kaplan Meier Survival Curve Analysis on H2AF2
```{r}
df_H2AFY <- df_rnaseq %>%
...
# Find all the histone variant in the rnaseq data
```{r}
...
# histone related variant and expression level
process the data to make the data format match
```{r}
...
# draw the expression box plot for histone variants
```{r}
